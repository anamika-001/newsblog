      ...
      <!-- <li class="treeview">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="{{url('/Admin/createmanager')}}"><i class="fa fa-circle-o"></i> Add Manager</a></li>
            <li><a href="{{url('/Admin/viewmanager')}}"><i class="fa fa-circle-o"></i> View Manager</a></li>
          </ul>
        </li>

        <li class="treeview active">
          <a href="{{url('Admin/addteammember')}}">
            <i class="fa fa-edit"></i> <span>Team Member</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="{{url('/Admin/createteammember')}}"><i class="fa fa-circle-o"></i> Add Team Member</a></li>
            <li><a href="{{url('/Admin/viewteammember')}}"><i class="fa fa-circle-o"></i> View Team Member</a></li>
          </ul>
        </li>
